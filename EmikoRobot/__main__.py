...
PM_START_TEXT = """
*Hello {} !*
✪ I'm GabutProtection management bot [✨](https://telegra.ph/file/e7bbf0185b5c52e281681.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Emiko To Your Group ➗", url="t.me/{dispatcher.bot.username}?startgroup=new"),
    ],
]
...
EMI_IMG = "https://telegra.ph/file/e7bbf0185b5c52e281681.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @Rommelxx \
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *GabutProtection*, a powerful group management bot built to help you manage your group easily."
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, GabutProtection now ready to manage your group."
            "\n\n*Admin Tools*"
